...
import { deleteQuestionAction } from "@/src/actions/exam-builder"; // 👈 Import the action
...
export function QuestionCard({ q, i }: { q: any; i: number }) {
  ...
  const handleDelete = () => {
    startTransition(async () => {
      // Assuming 'q' has examId. If not, you might need to pass examId as a prop to QuestionCard
  ...
  return (
    <Card className="group relative overflow-hidden border-slate-200 shadow-sm transition-all hover:shadow-md hover:border-blue-300">
          ...
          <div className="flex items-center gap-1">
            ...
            <DropdownMenu>
              ...
              <DropdownMenuContent align="end" className="w-40">
                {/* 👈 Attach onClick to the delete button */}
                <DropdownMenuItem
      ...
      <CardContent className="p-6">
        {/* ... Rest of the card content (Question Text, Images, and Choices grid) stays exactly the same as the previous step ... */}
