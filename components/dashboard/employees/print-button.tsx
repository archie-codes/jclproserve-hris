...
export function PrintButton({ data }: { data: any }) {
  ...
  const generatePDF = async () => {
    ...
    try {
      ...
      doc.setFont("helvetica", "normal");
      doc.setTextColor(100);
      doc.text(data.position?.title || "No Position", 20, startY + 6);
      ...
      autoTable(doc, {
        ...
        body: [
          ...
          [
            "Emergency Contact",
            `${data.emergencyContactName || "N/A"} (${data.emergencyContactPhone || "N/A"})`,
          ],
        ],
        theme: tableTheme,
      ...
      autoTable(doc, {
        ...
        body: [
          ...
          [
            "Date Regularized",
            data.dateRegularized ? formatDate(data.dateRegularized) : "—",
          ],
          [
            "Date Resigned",
            data.dateResigned ? formatDate(data.dateResigned) : "—",
          ],
        ],
        theme: tableTheme,
        headStyles: headStyles,
      ...
      doc.text("Confidential / For Internal Use Only", 190, pageHeight - 10, {
        align: "right",
      });
