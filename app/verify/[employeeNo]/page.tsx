...
export default async function DigitalIdVerificationPage({
  ...
  return (
    <div className="min-h-screen bg-linear-to-br from-slate-950 via-slate-900 to-indigo-950 flex flex-col items-center justify-center p-4 sm:p-8 font-sans relative overflow-hidden">
      ...
      <div className="absolute top-[-20%] left-[-10%] w-160 h-160 bg-indigo-600/10 blur-3xl rounded-full animate-pulse mix-blend-screen pointer-events-none"></div>
      <div className="absolute bottom-[-10%] right-[-10%] w-160 h-160 bg-blue-500/10 blur-3xl rounded-full animate-pulse delay-700 mix-blend-screen pointer-events-none"></div>
      ...
      <div className="w-full max-w-6xl z-10 animate-in fade-in slide-in-from-bottom-8 duration-700">
        ...
        <div className="h-1 w-2/3 mx-auto mt-6 bg-linear-to-r from-transparent via-indigo-500/30 to-transparent blur-md"></div>
      </div>
    </div>
  );
}
